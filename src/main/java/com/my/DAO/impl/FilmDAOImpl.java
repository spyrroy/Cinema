...
public class FilmDAOImpl implements FilmDAO {
    ...
    private static final String ADD_NEW_FILM = "insert into film (name, description, duration) values (?, ?, ?)";
    ...
    private static final String UPDATE_FILM_BY_ID = "update film set name = ?, description = ?, duration = ? where film_id = ?";
    ...
    public List<Film> getAllFilms() {
        ...
        ResultSet resultSet = preparedStatement.executeQuery()) {
            while (resultSet.next()) {
                ...
                Film film = new Film(id, name, description, duration);
                films.add(film);
            }
        } catch (SQLException e) {
            throw new RuntimeException(e);
    ...
    public Film getFilmById(int id) {
        ...
        try (Connection connection = getConnection();
            ...
            while (resultSet.next()) {
                ...
                String description = resultSet.getString("description");
                int duration = resultSet.getInt("duration");
                film = new Film(filmId, name, description, duration);
            }
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
